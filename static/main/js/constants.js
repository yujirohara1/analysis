...
const BgColor_RadarChart =  ["rgba(2,35,199,.2)", "rgba(199,2,2,.2)", "rgba(42,199,2,.2)", "rgba(153,2,199,.2)", "rgba(199,120,2,.2)", "rgba(255,255,10,.2)", "rgba(255,122,255,.2)", "rgba(0,161,233,.2)"];
const BdrColor_RadarChart = ["rgba(2,35,199,1)",  "rgba(199,2,2,1)",  "rgba(42,199,2,1)",  "rgba(153,2,199,1)",  "rgba(199,120,2,1)", "rgba(204,204,0,1)", "rgba(255,71,255,1)", "rgba(0,161,233,1)"];
